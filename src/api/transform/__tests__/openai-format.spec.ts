...
describe("convertToOpenAiMessages", () => {
	...
	describe("reasoning_details transformation", () => {
		...
		it("should pass through all reasoning_details without extracting to top-level reasoning", () => {
			// This simulates the stored format after receiving from xAI/AI Code Orchestrator API
			// The provider (aico.ts) now consolidates all reasoning into reasoning_details
			const anthropicMessages = [
				{
					role: "assistant" as const,

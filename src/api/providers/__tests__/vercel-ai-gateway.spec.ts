...
import { vercelAiGatewayDefaultModelId, VERCEL_AI_GATEWAY_DEFAULT_TEMPERATURE } from "@ai-code-orchestrator/types"
	...
	it("initializes with correct options", () => {
		...
		expect(OpenAI).toHaveBeenCalledWith({
			...
			defaultHeaders: expect.objectContaining({
				...
				"User-Agent": expect.stringContaining("AiCodeOrchestrator/"),
			}),
		})
	})

// npx vitest core/ignore/__tests__/AicoIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { AicoIgnoreController } from "../AicoIgnoreController"
...
describe("AicoIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .aicoignore to exist with some patterns

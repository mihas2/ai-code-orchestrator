...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "aico_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	aico_read_date: z.number().nullable(),
	aico_edit_date: z.number().nullable(),

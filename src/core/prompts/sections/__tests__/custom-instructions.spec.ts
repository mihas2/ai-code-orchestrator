...
describe("loadRuleFiles", () => {
	...
	it("should read and trim file content", async () => {
		// Simulate no .ai-code-orchestrator/rules directory
	...
	it("should not combine content from multiple rule files when they exist", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().endsWith(".aicorules")) {
				return Promise.resolve("aico rules content")
			}
	...
	it("should use .ai-code-orchestrator/rules/ directory when it exists and has files", async () => {
		// Simulate .ai-code-orchestrator/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				parentPath: "/fake/path/.ai-code-orchestrator/rules",
			},
			{
				name: "file2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.ai-code-orchestrator/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.ai-code-orchestrator/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/file2.txt") {
		...
		const expectedRelativePath1 =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\file1.txt"
				: ".ai-code-orchestrator/rules/file1.txt"
		const expectedRelativePath2 =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\file2.txt"
				: ".ai-code-orchestrator/rules/file2.txt"
		...
		const expectedRulesDir =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules"
				: "/fake/path/.ai-code-orchestrator/rules"
		const expectedFile1Path =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules\\file1.txt"
				: "/fake/path/.ai-code-orchestrator/rules/file1.txt"
		const expectedFile2Path =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules\\file2.txt"
				: "/fake/path/.ai-code-orchestrator/rules/file2.txt"
	...
	it("should filter out cache files from .ai-code-orchestrator/rules/ directory", async () => {
		// Simulate .ai-code-orchestrator/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/rule1.txt") {
				return Promise.resolve("rule 1 content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/rule2.md") {
			...
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/.DS_Store") {
				return Promise.resolve("DS_STORE_BINARY_CONTENT")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/Thumbs.db") {
				return Promise.resolve("THUMBS_DB_CONTENT")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/backup.bak") {
				return Promise.resolve("BACKUP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/cache.log") {
				return Promise.resolve("LOG_CONTENT")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/temp.tmp") {
				return Promise.resolve("TEMP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/script.pyc") {
		...
		const expectedCacheFiles = [
			"/fake/path/.ai-code-orchestrator/rules/.DS_Store",
			"/fake/path/.ai-code-orchestrator/rules/Thumbs.db",
			"/fake/path/.ai-code-orchestrator/rules/backup.bak",
			"/fake/path/.ai-code-orchestrator/rules/cache.log",
			"/fake/path/.ai-code-orchestrator/rules/temp.tmp",
			"/fake/path/.ai-code-orchestrator/rules/script.pyc",
		]
	...
	it("should fall back to .aicorules when .ai-code-orchestrator/rules/ is empty", async () => {
		// Simulate .ai-code-orchestrator/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .ai-code-orchestrator/rules/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.ai-code-orchestrator/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.ai-code-orchestrator/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRelativeRootPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\root.txt"
				: ".ai-code-orchestrator/rules/root.txt"
		const expectedRelativeNested1Path =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\subdir\\nested1.txt"
				: ".ai-code-orchestrator/rules/subdir/nested1.txt"
		const expectedRelativeNested2Path =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\subdir\\subdir2\\nested2.txt"
				: ".ai-code-orchestrator/rules/subdir/subdir2/nested2.txt"
		...
		const expectedRootPath2 =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules\\root.txt"
				: "/fake/path/.ai-code-orchestrator/rules/root.txt"
		const expectedNested1Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules\\subdir\\nested1.txt"
				: "/fake/path/.ai-code-orchestrator/rules/subdir/nested1.txt"
		const expectedNested2Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.ai-code-orchestrator/rules/subdir/subdir2/nested2.txt"
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .ai-code-orchestrator/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
		...
		expect(result).toContain("Rules from .aicorules-test-mode:\nmode specific rules")
	})
	...
	it("should include AGENTS.md content along with other rules", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (pathStr.endsWith(".aicorules")) {
				return Promise.resolve("AI Code Orchestrator rules content")
			}
			return Promise.reject({ code: "ENOENT" })
		})
		...
		// Should contain both AGENTS.md and .aicorules content
		expect(result).toContain("# Agent Rules Standard (AGENTS.md):")
		expect(result).toContain("Agent rules content")
		expect(result).toContain("# Rules from .aicorules:")
		expect(result).toContain("AI Code Orchestrator rules content")
	})
	...
	it("should use .ai-code-orchestrator/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .ai-code-orchestrator/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.ai-code-orchestrator/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			if (
				normalizedPath.includes("/fake/path/.ai-code-orchestrator/rules-test-mode/rule1.txt") ||
				normalizedPath.includes("/fake/path/.ai-code-orchestrator/rules-test-mode/rule2.txt")
			) {
				return Promise.resolve({
					isFile: vi.fn().mockReturnValue(true),
				}) as any
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules-test-mode/rule2.txt") {
		...
		const expectedRelativeRule1Path =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules-test-mode\\rule1.txt"
				: ".ai-code-orchestrator/rules-test-mode/rule1.txt"
		const expectedRelativeRule2Path =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules-test-mode\\rule2.txt"
				: ".ai-code-orchestrator/rules-test-mode/rule2.txt"
		...
		const expectedAbsTestModeDir =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules-test-mode"
				: "/fake/path/.ai-code-orchestrator/rules-test-mode"
		const expectedAbsRule1Path =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules-test-mode\\rule1.txt"
				: "/fake/path/.ai-code-orchestrator/rules-test-mode/rule1.txt"
		const expectedAbsRule2Path =
			process.platform === "win32"
				? "\\fake\\path\\.ai-code-orchestrator\\rules-test-mode\\rule2.txt"
				: "/fake/path/.ai-code-orchestrator/rules-test-mode/rule2.txt"
	...
	it("should fall back to .aicorules-test-mode when .ai-code-orchestrator/rules-test-mode/ does not exist", async () => {
		// Simulate .ai-code-orchestrator/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })

		// Simulate .aicorules-test-mode exists
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".aicorules-test-mode")) {
	...
	it("should fall back to .clinerules-test-mode when .ai-code-orchestrator/rules-test-mode/ and .aicorules-test-mode do not exist", async () => {
		// Simulate .ai-code-orchestrator/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should correctly format content from directories when using .ai-code-orchestrator/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
			...
			.mockResolvedValueOnce([
				{
					...
					isFile: () => true,
					parentPath: "/fake/path/.ai-code-orchestrator/rules/symlink-target-dir",
				},
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.ai-code-orchestrator/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: vi.fn().mockReturnValue(true),
					isFile: vi.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/nested-symlink-target.txt") {
		...
		const expectedRelativeRegularPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\regular.txt"
				: ".ai-code-orchestrator/rules/regular.txt"
		const expectedRelativeSymlinkPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\symlink-target.txt"
				: ".ai-code-orchestrator/symlink-target.txt"
		const expectedRelativeSubdirPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\symlink-target-dir\\subdir_link.txt"
				: ".ai-code-orchestrator/rules/symlink-target-dir/subdir_link.txt"
		const expectedRelativeNestedPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\nested-symlink-target.txt"
				: ".ai-code-orchestrator/nested-symlink-target.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.ai-code-orchestrator/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.ai-code-orchestrator/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.ai-code-orchestrator/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.ai-code-orchestrator/symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith(
			"/fake/path/.ai-code-orchestrator/rules/symlink-target-dir/subdir_link.txt",
			"utf-8",
		)
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.ai-code-orchestrator/nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		vi.clearAllMocks()
	})
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			expect([
				"/fake/path/.ai-code-orchestrator/rules/file1.txt",
				"/fake/path/.ai-code-orchestrator/rules/file2.txt",
				"/fake/path/.ai-code-orchestrator/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/file3.txt") {
		...
		const expectedRelativeFile3Path =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\file3.txt"
				: ".ai-code-orchestrator/rules/file3.txt"
	...
	it("should return files in alphabetical order by filename", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "zebra.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules" },
			{ name: "alpha.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules" },
			{ name: "Beta.txt", isFile: () => true, parentPath: "/fake/path/.ai-code-orchestrator/rules" }, // Test case-insensitive sorting
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			const pathStr = filePath.toString()
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/zebra.txt") {
				return Promise.resolve("zebra content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/alpha.txt") {
				return Promise.resolve("alpha content")
			}
			if (normalizedPath === "/fake/path/.ai-code-orchestrator/rules/Beta.txt") {
		...
		const expectedRelativeAlphaPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\alpha.txt"
				: ".ai-code-orchestrator/rules/alpha.txt"
		const expectedRelativeBetaPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\Beta.txt"
				: ".ai-code-orchestrator/rules/Beta.txt"
		const expectedRelativeZebraPath =
			process.platform === "win32"
				? ".ai-code-orchestrator\\rules\\zebra.txt"
				: ".ai-code-orchestrator/rules/zebra.txt"
	...
	it("should sort symlinks by their symlink names, not target names", async () => {
		...
		// First call: check if .ai-code-orchestrator/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)

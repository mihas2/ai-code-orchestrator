...
vi.mock("fs/promises")
vi.mock("../aico-config", () => ({
	getGlobalAicoDirectory: vi.fn(() => "/mock/global/.ai-code-orchestrator"),
	getProjectAicoDirectoryForCwd: vi.fn(() => "/mock/project/.ai-code-orchestrator"),
}))
...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ai-code-orchestrator", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".ai-code-orchestrator", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
				mode: undefined,
			})
	...
	describe("argument-hint functionality", () => {
		it("should load command with argument-hint from frontmatter", async () => {
			const commandContent = `---
description: Create a new release of the AI Code Orchestrator extension
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ai-code-orchestrator", "commands", "release.md"),
				description: "Create a new release of the AI Code Orchestrator extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ai-code-orchestrator", "commands", "deploy.md"),
				description: "Deploy application to environment",
...
Start debugging.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".ai-code-orchestrator", "commands", "debug-app.md"),
				description: "Debug the application",
				argumentHint: undefined,
				mode: "debug",
			})

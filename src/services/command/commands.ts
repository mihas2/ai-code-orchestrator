...
import { getGlobalAicoDirectory, getProjectAicoDirectoryForCwd } from "../aico-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalAicoDirectory(), "commands")
	...
	const projectDir = path.join(getProjectAicoDirectoryForCwd(cwd), "commands")

...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .ai-code-orchestrator/rules-code/AGENTS.md (relative to project root)
       - .ai-code-orchestrator/rules-debug/AGENTS.md (relative to project root)
       - .ai-code-orchestrator/rules-ask/AGENTS.md (relative to project root)
       - .ai-code-orchestrator/rules-architect/AGENTS.md (relative to project root)
       ...
       - .cursorrules, CLAUDE.md, .aicorules
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .ai-code-orchestrator/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .ai-code-orchestrator folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .ai-code-orchestrator/rules-code/AGENTS.md (create .ai-code-orchestrator in project root, not system root!)
    - .ai-code-orchestrator/rules-debug/AGENTS.md (relative to project root)
    - .ai-code-orchestrator/rules-ask/AGENTS.md (relative to project root)
    - .ai-code-orchestrator/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .ai-code-orchestrator directory must be created in the current project/workspace root directory,
    ...
    ├── .ai-code-orchestrator/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .ai-code-orchestrator/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .ai-code-orchestrator/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .ai-code-orchestrator/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .ai-code-orchestrator/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:

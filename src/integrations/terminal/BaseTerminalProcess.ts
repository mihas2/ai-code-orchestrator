...
import type { AicoTerminalProcess, AicoTerminalProcessEvents, ExitCodeDetails } from "./types"

export abstract class BaseTerminalProcess
	extends EventEmitter<AicoTerminalProcessEvents>
	implements AicoTerminalProcess
{
	...
	// of before sending request to AI Code Orchestrator.

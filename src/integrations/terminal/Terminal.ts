...
import type { AicoTerminalCallbacks, AicoTerminalProcessResultPromise } from "./types"
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "AI Code Orchestrator", iconPath, env })
	...
	public override runCommand(command: string, callbacks: AicoTerminalCallbacks): AicoTerminalProcessResultPromise {

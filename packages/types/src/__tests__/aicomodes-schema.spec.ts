/**
 * Validates the generated schemas/agent-modes.json against sample configurations
 * using AJV. The schema itself is dynamically generated from the Zod types in
 * packages/types/src/mode.ts -- see packages/types/scripts/generate-agent-modes-schema.ts.
 *
 * A separate drift-detection test (agent-modes-schema-sync.spec.ts) ensures the
...
describe("agent-modes JSON schema", () => {
	...
	it("should accept a minimal valid .agent-modes config", () => {
		const config = {
			customModes: [
				{
					slug: "my-mode",

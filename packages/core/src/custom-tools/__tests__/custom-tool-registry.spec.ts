// pnpm --filter @ai-code-orchestrator/core test src/custom-tools/__tests__/custom-tool-registry.spec.ts

import path from "path"
import { fileURLToPath } from "url"

import { type CustomToolDefinition, parametersSchema as z } from "@ai-code-orchestrator/types"

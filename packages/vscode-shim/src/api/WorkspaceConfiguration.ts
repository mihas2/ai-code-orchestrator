 ...
 * @param section The configuration section (e.g., "ai-code-orchestrator")
 ...
 * @param fullKey The full configuration key (e.g., "ai-code-orchestrator.commandExecutionTimeout")

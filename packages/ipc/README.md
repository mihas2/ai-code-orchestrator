...
This package provides IPC functionality for AI Code Orchestrator, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: AiCodeOrchestrator settings object
...
```typescript
import { IpcClient } from "@AI Code Orchestrator/ipc"
...
- Unix/Linux/macOS: `/tmp/AI Code Orchestrator-{id}.sock`
- Windows: `\\.\pipe\AI Code Orchestrator-{id}`

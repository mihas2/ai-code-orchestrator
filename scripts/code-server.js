/**
 * Serve script for AI Code Orchestrator extension development
 *
 * Usage:
...
const VSIX_PATH = path.join(os.tmpdir(), "ai-code-orchestrator-serve.vsix")
...
async function main() {
	console.log(`\n${BOLD}🔧 AI Code Orchestrator - Install Extension${RESET}\n`)

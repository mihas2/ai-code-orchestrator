		...
		<div
			...
			<div
				style={{
					...
					WebkitMaskImage: `url('${imagesBaseUri}/aico-logo.svg')`,
					WebkitMaskRepeat: "no-repeat",
					WebkitMaskSize: "contain",
					maskImage: `url('${imagesBaseUri}/aico-logo.svg')`,
				...
				<img src={imagesBaseUri + "/aico-logo.svg"} alt="AI Code Orchestrator logo" className="h-8 opacity-0" />
			</div>
			<div
				className="w-[200%] -mt-0.25 h-0.5 overflow-hidden opacity-0 group-hover:opacity-70 transition-opacity duration-300"
				data-testid="aico-hero-ground">

	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				"chat:slashCommand.wantsToRun": "AI Code Orchestrator wants to run slash command:",
				"chat:slashCommand.didRun": "AI Code Orchestrator ran slash command:",
			}
...
describe("ChatRow - runSlashCommand tool", () => {
	...
	it("should display runSlashCommand ask message with command only", () => {
		...
		expect(getByText("AI Code Orchestrator wants to run slash command:")).toBeInTheDocument()
	...
	it("should display runSlashCommand say message", () => {
		...
		expect(getByText("AI Code Orchestrator ran slash command:")).toBeInTheDocument()

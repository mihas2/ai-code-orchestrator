---
description: "Translate and localize strings in the AI Code Orchestrator extension"
argument-hint: "[language-code or 'all'] [string-key or file-path]"
mode: translate
---

Perform translation and localization tasks for the AI Code Orchestrator extension. This command activates the translation workflow with comprehensive i18n guidelines.
...
- `/aico-translate de` - Focus on German translations
- `/aico-translate all welcome.title` - Translate a specific key to all languages
- `/aico-translate zh-CN src/i18n/locales/zh-CN/core.json` - Work on specific file

---
name: aico-translation
description: Provides comprehensive guidelines for translating and localizing AI Code Orchestrator extension strings. Use when tasks involve i18n, translation, localization, adding new languages, or updating existing translation files. This skill covers both core extension (src/i18n/locales/) and WebView UI (webview-ui/src/i18n/locales/) localization.
---

# AI Code Orchestrator Translation Skill

## When to Use This Skill

Use this skill when the task involves:

- Adding new translatable strings to the AI Code Orchestrator extension
...
- [`.ai-code-orchestrator/guidance/aico-translator.md`](../../guidance/aico-translator.md)

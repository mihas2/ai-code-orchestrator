---
name: evals-context
description: Provides context about the AI Code Orchestrator evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-AI Code Orchestrator/src/app/evals).
---
...
- Modifying the public evals display page on AI Code Orchestrator.com
...
| **Website Evals Page**      | `apps/web-AI Code Orchestrator/src/app/evals/`                                             | Public AI Code Orchestrator.com page displaying eval results   |
| **External Exercises Repo** | [AI Code Orchestrator-Evals](https://github.com/AIOrchestrator/ai-code-orchestrator-Evals) | Actual coding exercises (NOT in this monorepo)                 |
...
### `apps/web-AI Code Orchestrator/src/app/evals/` - Public Website Evals Page

```
apps/web-AI Code Orchestrator/src/app/evals/
...
This page **displays** eval results on the public AI Code Orchestrator.com website. It imports types from `@AI Code Orchestrator/evals` but does NOT run evals.
...
- **Runner**: Isolated Docker container with VS Code + AI Code Orchestrator extension + language runtimes
...
1. Add exercise to [AI Code Orchestrator-Evals](https://github.com/AIOrchestrator/ai-code-orchestrator-Evals) repo (external)
...
Edit files in [`apps/web-AI Code Orchestrator/src/app/evals/`](apps/web-AI Code Orchestrator/src/app/evals/):

- [`evals.tsx`](apps/web-AI Code Orchestrator/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-AI Code Orchestrator/src/app/evals/plot.tsx) - Charts
...
## Key Types/Exports from `@AI Code Orchestrator/evals`
...
- Used by both `apps/web-evals` and `apps/web-AI Code Orchestrator`

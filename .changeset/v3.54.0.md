...
- Remove: AI Code Orchestrator Cloud and eval infrastructure from the extension, CLI, workflows, and package surfaces so the release is focused on the standalone extension (PR #12328 by @mrubens)
...
- Update: Extension-facing support, diagnostics, and announcement content for the final AI Code Orchestrator release, including GitHub help paths and links to remote, ZooCode, and Cline (PR #12341 by @brunobergher)
...
- Remove: Stale `AI Code Orchestrator.github.io` docs references, including the old CNAME and outdated docs README and robots.txt URLs (PR #12372 by @mrubens)
- Update: The website to focus almost entirely on the AI Code Orchestrator extension and remove cloud, team, enterprise, provider, pricing, Slack, and Linear product pages (PR #12180 by @brunobergher)

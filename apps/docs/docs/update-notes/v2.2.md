---
description: AI Code Orchestrator 2.2 introduces MCP support for custom tools, API configuration profiles, enhanced diff editing, and numerous quality-of-life improvements.
keywords:
...
# AI Code Orchestrator 2.2 Release Notes (2025-02-27)
...
- **Model Context Protocol (MCP) Support (v2.2.0):**
    - Added support for MCP, enabling AI Code Orchestrator to use custom tools like web search or GitHub tools.
    - Added an MCP server management tab.
    - Enabled AI Code Orchestrator to dynamically create new MCP servers based on user requests.
...
- **AI Code Orchestrator Cline Runs in All VSCode-Compatible Editors (v2.1.6).**
- **AI Code Orchestrator Cline Side-by-Side with Cline (v2.1.4).**

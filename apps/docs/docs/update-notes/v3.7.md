---
description: AI Code Orchestrator 3.7 introduces Claude Sonnet 3.7 support, expanded thinking models with 128k tokens, Mermaid diagrams, keyboard shortcuts, and numerous improvements.
keywords:
    - AI Code Orchestrator 3.7
    - claude sonnet 3.7
    - thinking models
    - mermaid diagrams
    - keyboard shortcuts
...
# AI Code Orchestrator 3.7 Release Notes (2025-03-03)

This release cycle introduces AI Code Orchestrator 3.7 with Claude Sonnet 3.7 support, expanded model capabilities (including "Thinking" Sonnet and increased token limits), Vertex AI enhancements, improved context window management, UI refinements like Mermaid diagrams and drag-and-drop, and numerous bug fixes.

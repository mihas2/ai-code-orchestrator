---
description: AI Code Orchestrator 3.1.7 adds support for DeepSeek-R1 models, introduces experimental unified diff algorithm, and fixes API configuration profiles.
keywords:
...
# AI Code Orchestrator 3.1.7 Release Notes

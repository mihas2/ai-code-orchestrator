---
description: AI Code Orchestrator 3.1.6 adds support for the Mistral provider and fixes a bug with saving VSCode Language Models configuration profiles.
keywords:
...
# AI Code Orchestrator 3.1.6 Release Notes

---
description: AI Code Orchestrator 3.11.16 adds gpt-4.1, gpt-4.1-mini, and gpt-4.1-nano models to OpenAI provider and includes model ID in task details.
keywords:
...
# AI Code Orchestrator 3.11.16 Release Notes (2025-04-14)

---
description: AI Code Orchestrator 2.2.45 introduces API Configuration Profiles, allowing you to save and quickly switch between different API setups and providers.
keywords:
...
# AI Code Orchestrator 2.2.45 Release Notes

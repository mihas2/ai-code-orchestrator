---
description: AI Code Orchestrator 3.11.15 adds workspace-based task history filtering, package.json localization, and Anthropic Authorization header support.
keywords:
...
# AI Code Orchestrator 3.11.15 Release Notes (2025-04-13)

---
description: AI Code Orchestrator 3.2 marks the rebranding from AI Code Orchestrator Cline, introduces Custom Modes for specialized assistants, and includes provider updates and fixes.
keywords:
...
# AI Code Orchestrator 3.2 Release Notes (2025-02-27)

This release cycle primarily focused on the rebranding from AI Code Orchestrator Cline to AI Code Orchestrator, the introduction of Custom Modes, and several provider updates and bug fixes.

---

## Name Change & Custom Modes (v3.2.0 - v3.2.2)

- **Name Change From AI Code Orchestrator Cline to AI Code Orchestrator:** Rebranded to AI Code Orchestrator to better reflect its identity.
- **Custom Modes:** Introduced the ability to create custom personas for AI Code Orchestrator, define custom prompts, choose tool access for each mode, and create specialized assistants. Users can get started via the Prompts tab or by typing "Create a new mode for ".

---
description: AI Code Orchestrator 3.3.2 improves mode configuration with API dropdowns, fixes MCP tools, enhances OpenRouter DeepSeek-R1 support, and refines UI elements.
keywords:
    - AI Code Orchestrator 3.3.2
    - mode configuration
    - openrouter
    - deepseek r1
    - mcp tools
...
# AI Code Orchestrator 3.3.2 Release Notes

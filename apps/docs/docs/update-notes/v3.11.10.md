---
description: AI Code Orchestrator 3.11.10 fixes nested .ai-code-orchestrator/rules directories, OpenAI provider caching, and improves command output handling and translations.
keywords:
...
# AI Code Orchestrator 3.11.10 Release Notes (2025-04-08)
...
- Fixed bug where nested `.ai-code-orchestrator/rules` directories are not respected properly (thanks @taisukeoe!).

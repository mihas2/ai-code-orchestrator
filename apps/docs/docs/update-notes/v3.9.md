---
description: AI Code Orchestrator v3.9 enhances usability by allowing concurrent file reads for faster context gathering, improving diff view readability, and refining UI elements for a smoother user experience.
---

# AI Code Orchestrator 3.9 Release Notes (2025-03-19)
...
- **Broad Language Support:** AI Code Orchestrator has been internationalized into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese. (thanks @feifei325!)
- **Text-to-Speech:** Added an option to have AI Code Orchestrator talk to you as it works, including persisting the speed state. (thanks @heyseth!)
...
- **Expose Task Stack in API:** The task stack is now exposed in the `AiCodeOrchestratorAPI`. (thanks @franekp!)
...
- **Task History Saving (Multiple Roos):** Fixed task history saving when running multiple instances of AI Code Orchestrator. (thanks @samhvw8!)
...
- **Wheel Scrolling in Editor Tabs:** Fixed wheel scrolling when AI Code Orchestrator is opened in editor tabs. (thanks @GitlyHallows!)

---
description: AI Code Orchestrator 3.3.22 adds MCP server deletion, wildcard command auto-approval, enhanced provider settings UI, custom language preferences, Catalan support, and Ollama reasoning tags.
keywords:
    - AI Code Orchestrator 3.3.22
    - mcp server delete
...
# AI Code Orchestrator 3.3.22 Release Notes (2025-02-20)
...
- Fixed the `.agent-modes` file not being automatically created when adding custom modes from the Prompts tab.

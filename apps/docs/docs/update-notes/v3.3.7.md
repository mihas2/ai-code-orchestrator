---
description: AI Code Orchestrator 3.3.7 adds o3-mini model support, improves Code Actions with direct context addition, introduces API rate limiting with exponential backoff, and enhances tool interactions.
keywords:
    - AI Code Orchestrator 3.3.7
    - o3-mini
    - code actions
    - api rate limiting
    - exponential backoff
...
# AI Code Orchestrator 3.3.7 Release Notes
...
- Tweaked prompts to improve AI Code Orchestrator's ability to create new custom modes.

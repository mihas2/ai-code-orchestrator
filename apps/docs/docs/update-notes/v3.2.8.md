---
description: AI Code Orchestrator 3.2.8 fixes custom modes settings, improves API key entry validation, adds Azure checkbox for OpenAI, and updates Bedrock models.
keywords:
...
# AI Code Orchestrator 3.2.8 Release Notes

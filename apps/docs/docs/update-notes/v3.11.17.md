---
description: AI Code Orchestrator 3.11.17 improves OpenAI cache reporting, enhances auto-approve toggles UI, and fixes diff logic and terminal race conditions.
keywords:
...
# AI Code Orchestrator 3.11.17 Release Notes (2025-04-14)

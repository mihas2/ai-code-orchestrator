---
description: AI Code Orchestrator 3.3.21 introduces @terminal mention to pull recent terminal output into context, enables o1 model streaming, and fixes language settings and Mistral provider.
keywords:
    - AI Code Orchestrator 3.3.21
    - terminal mention
    - o1 streaming
    - mistral fix
    - language settings
...
# AI Code Orchestrator 3.3.21 Release Notes (2025-02-17)
...
- Fixed the system prompt to ensure AI Code Orchestrator is aware of all available modes.

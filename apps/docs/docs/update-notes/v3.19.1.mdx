...
# AI Code Orchestrator 3.19.1 Release Notes (2025-05-31)
...
This experimental feature transforms how AI Code Orchestrator understands and works with your entire codebase at once (thanks samhvw8!).
...
Enterprise customers can now use AI Code Orchestrator with AWS Bedrock while maintaining complete network security (thanks kcwhite!). See the [AWS Bedrock configuration guide](/providers/bedrock#configuration-in-AI Code Orchestrator) for setup instructions.

---
description: AI Code Orchestrator 3.14.2 introduces Gemini prompt caching for faster responses, terminal improvements, and adds Russian language support.
keywords:
...
# AI Code Orchestrator 3.14.2 Release Notes (2025-04-24)

---
description: This release cycle introduces opt-in telemetry, significant terminal architecture improvements, a multi-diff editing strategy, .aicoignore support, and a redesigned settings page, alongside numerous provider updates and bug fixes.
---

# AI Code Orchestrator 3.8 Release Notes (2025-03-13)

This release cycle introduces opt-in telemetry, significant terminal architecture improvements, a multi-diff editing strategy, `.aicoignore` support, and a redesigned settings page, alongside numerous provider updates and bug fixes.

---

## Key Features & Enhancements

- **Opt-in Telemetry:** Added opt-in telemetry to help improve AI Code Orchestrator faster. (thanks Cline!)
...
- **`.aicoignore` Support:** Added support for a `.aicoignore` file to prevent AI Code Orchestrator from reading/writing specified files, with an option to exclude them from search/lists. (thanks Cline!)
...
- **Simultaneous AI Code Orchestrator Instances:** Support for running AI Code Orchestrator in multiple editor windows simultaneously. (thanks @samhvw8!)

---
description: AI Code Orchestrator 3.3.15 introduces experimental Checkpoints for tracking project changes, adds copy button to recent tasks, enhances API profile flow, and fixes MCP initialization.
keywords:
    - AI Code Orchestrator 3.3.15
    - checkpoints
...
# AI Code Orchestrator 3.3.15 Release Notes (2025-02-08)

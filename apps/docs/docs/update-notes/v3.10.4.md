---
description: AI Code Orchestrator 3.10.4 adds Gemini 2.5 Pro, R1 support for QWQ models, Bedrock application-inference-profile, improved UI/UX, and dynamic mode instructions fetching.
keywords:
    - AI Code Orchestrator 3.10.4
    - gemini 2.5 pro
    - r1 support
    - qwq models
    - bedrock inference
...
# AI Code Orchestrator 3.10.4 Release Notes (2025-03-25)

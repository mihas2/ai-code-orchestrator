---
description: AI Code Orchestrator 3.50.0 adds Gemini 3.1 Pro support with updated default model and overhauls the CLI stdin interface with a structured NDJSON protocol and new list subcommands.
keywords:
  - AI Code Orchestrator 3.50.0
  - gemini 3.1 pro
  - ndjson stdin
  - cli list subcommands
---

# AI Code Orchestrator 3.50.0 Release Notes (2026-02-19)

---
description: AI Code Orchestrator 3.12 adds xAI provider support, profile-specific diff settings, keyboard shortcuts for input, and search in dropdowns.
keywords:
...
# AI Code Orchestrator 3.12 Release Notes (2025-04-16)
...
Added the `aico.acceptInput` command to allow users to accept input or suggestions using keyboard shortcuts instead of mouse clicks. (thanks axkirillov!) This feature:

---
description: AI Code Orchestrator 3.3.0 introduces native VS Code actions, intelligent mode switching, enhanced Markdown support, and AWS profile configuration for Bedrock provider.
keywords:
    - AI Code Orchestrator 3.3.0
    - code actions
    - mode switching
    - markdown support
    - aws bedrock
...
# AI Code Orchestrator 3.3.0 Release Notes

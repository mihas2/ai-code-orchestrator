...
# AI Code Orchestrator 3.16 Release Notes (2025-05-12)
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the AI Code Orchestrator settings (thanks KJ7LNW!)

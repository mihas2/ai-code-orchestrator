---
description: AI Code Orchestrator 3.18 introduces experimental codebase indexing, enhanced context condensing, YAML support for custom modes, and Gemini 2.5 Flash support.
keywords:
  - AI Code Orchestrator 3.18
  - release notes
  - codebase indexing
  - context condensing
  - YAML custom modes
...
# AI Code Orchestrator 3.18 Release Notes (2025-05-21)
...
Custom mode configuration is now significantly improved with **YAML support** for both global and project-level (`.agent-modes`) definitions. YAML is the new default, offering superior readability with cleaner syntax, support for comments (`#`), and easier multi-line string management. While JSON remains supported for backward compatibility, YAML streamlines mode creation, sharing, and version control.
...
To enhance API cost management, you can now set a **Max Requests** limit for auto-approved actions. This prevents AI Code Orchestrator from making an excessive number of consecutive API calls without your re-approval.

<img src="/img/v3.18.0/v3.18.0.png" alt="Setting the Max Requests limit for auto-approved actions in AI Code Orchestrator settings." width="600" />
...
*   **Automated Nightly Builds**: Created automated [nightly release system](/advanced-usage/AI Code Orchestrator-nightly) to deliver the latest features and fixes more quickly

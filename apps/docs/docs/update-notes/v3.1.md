---
description: AI Code Orchestrator 3.1 brings customizable chat mode prompts, DeepSeek-R1 support, Mistral provider, auto-approve chat bar, and numerous improvements.
keywords:
...
# AI Code Orchestrator 3.1 Release Notes (2025-02-27)

---
description: AI Code Orchestrator 3.1.3 introduces the auto-approve chat bar for quicker action approvals and fixes VS Code Language Models integration bug.
keywords:
...
# AI Code Orchestrator 3.1.3 Release Notes

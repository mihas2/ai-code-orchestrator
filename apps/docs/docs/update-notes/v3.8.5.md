---
description: AI Code Orchestrator 3.8.5 features major terminal architecture improvements, MCP over SSE support, remote browser connectivity, and expanded provider capabilities.
keywords:
    - AI Code Orchestrator 3.8.5
    - terminal refactor
    - mcp sse
    - remote browser
    - deepseek r1
...
# AI Code Orchestrator 3.8.5 Release Notes (2025-03-12)

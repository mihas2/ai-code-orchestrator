---
description: AI Code Orchestrator 3.7.12 expands thinking model capabilities to 128k tokens, improves context management with Anthropic count_tokens API, and adds browser tool controls.
keywords:
    - AI Code Orchestrator 3.7.12
    - thinking models
    - 128k tokens
    - context management
    - anthropic api
...
# AI Code Orchestrator 3.7.12 Release Notes (2025-03-03)

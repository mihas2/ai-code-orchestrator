---
description: AI Code Orchestrator 3.49.0 adds a file changes panel per conversation, per-workspace codebase indexing control, and fixes chat scroll and multi-window history reliability.
keywords:
  - AI Code Orchestrator 3.49.0
  - file changes panel
...
# AI Code Orchestrator 3.49.0 Release Notes (2026-02-19)

---
description: AI Code Orchestrator 3.16.4 improves provider profile management, fixes terminal focus issues, and enhances UI display for better user experience.
keywords:
...
# AI Code Orchestrator 3.16.4 Release Notes (2025-05-09)

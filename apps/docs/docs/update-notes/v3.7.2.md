---
description: AI Code Orchestrator 3.7.2 fixes computer use and prompt caching for OpenRouter's Claude 3.7, resolves context window overflows, and encourages diff editing in prompts.
keywords:
    - AI Code Orchestrator 3.7.2
    - claude sonnet 3.7
    - openrouter
    - computer use
    - prompt caching
...
# AI Code Orchestrator 3.7.2 Release Notes (2025-02-24)

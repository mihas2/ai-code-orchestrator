---
description: AI Code Orchestrator 3.11.12 enables Grok3 streaming through OpenAI Compatible providers and makes diff editing more tolerant of model errors.
keywords:
...
# AI Code Orchestrator 3.11.12 Release Notes (2025-04-09)

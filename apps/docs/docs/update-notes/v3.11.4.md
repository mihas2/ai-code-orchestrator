---
description: AI Code Orchestrator 3.11.4 adds tree-sitter support for TSX, TypeScript, JSON, and Markdown, fixes Windows unit tests, improves UI elements, and enhances provider support.
keywords:
    - AI Code Orchestrator 3.11.4
    - tree-sitter
    - tsx support
    - typescript
    - json
...
# AI Code Orchestrator 3.11.4 Release Notes (2025-04-02)

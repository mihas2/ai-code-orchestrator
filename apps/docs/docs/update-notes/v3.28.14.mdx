...
keywords:
  - AI Code Orchestrator 3.28.14
  - new features
  - bug fixes
image: /img/v3.28.14/v3.28.14.png
---

# AI Code Orchestrator 3.28.14 Release Notes (2025-09-30)
...
<img src="/img/v3.28.14/v3.28.14.png" alt="AI Code Orchestrator v3.28.14 Release" width="600" />

## Provider Updates

### GLM‑4.6 on Z.ai

We’ve added the GLM‑4.6 model to the Z.ai provider (thanks dmarkey!) ([#8408](https://github.com/AIOrchestrator/ai-code-orchestrator/pull/8408)). What you get:

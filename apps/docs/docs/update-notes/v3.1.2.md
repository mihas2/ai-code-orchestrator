---
description: AI Code Orchestrator 3.1.2 adds experimental VS Code Language Models support including Copilot, improves fuzzy search, and fixes configuration bugs.
keywords:
...
# AI Code Orchestrator 3.1.2 Release Notes

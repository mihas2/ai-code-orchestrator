...
# AI Code Orchestrator 3.19.0 Release Notes (2025-05-30)
...
*   **Enhanced Sidebar Compatibility**: Menu functionality now remains stable when moving AI Code Orchestrator between primary and secondary sidebars (thanks chrarnoldus!)

---

## Bug Fixes

*   **Directory Mention Protection**: Fixed [`@directory`](/basic-usage/context-mentions) not respecting [`.aicoignore`](/features/aicoignore) files (thanks xyOz-dev!)
*   **Tool File Protection**: Added [`aicoignore`](/features/aicoignore) checking for `insert_content` and `search_and_replace` tools

---
description: AI Code Orchestrator 3.15 adds Google Vertex prompt caching, terminal command fallback, enhanced Boomerang mode, and settings import/export.
keywords:
...
# AI Code Orchestrator 3.15 Release Notes (2025-05-05)
...
- AI Code Orchestrator settings can now be imported directly from the welcome screen (thanks julionav).
...
- Simplified and streamlined AI Code Orchestrator's [quick actions](/features/code-actions).

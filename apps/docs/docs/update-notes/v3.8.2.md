---
description: AI Code Orchestrator 3.8.2 adds auto-approval toggle for Boomerang Tasks, progress indicators for multi-diff editing, o3-mini support, and fixes encoding issues.
keywords:
    - AI Code Orchestrator 3.8.2
    - auto-approval
    - boomerang tasks
    - subtasks
    - o3-mini
...
# AI Code Orchestrator 3.8.2 Release Notes (2025-03-08)

---
description: AI Code Orchestrator 3.16.1 adds LiteLLM provider support, tool loop detection for improved stability, Dutch localization, and various UI improvements.
keywords:
...
# AI Code Orchestrator 3.16.1 Release Notes (2025-05-07)
...
- **Automatic Model Discovery**: AI Code Orchestrator automatically fetches and lists available models from your LiteLLM server. This means users no longer need to manually configure each LiteLLM model within AI Code Orchestrator, streamlining setup and making it easier to switch between models served by LiteLLM.

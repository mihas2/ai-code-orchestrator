---
description: AI Code Orchestrator 2.1 introduces diff editing, OpenRouter compression, sound effects, VSCode compatibility, and side-by-side Cline support.
keywords:
    - AI Code Orchestrator 2.1
    - major release
    - diff editing
...
# AI Code Orchestrator 2.1 Release Notes (2025-02-27)

This release cycle, prior to the introduction of MCP and major version 2.2, focused on foundational improvements including experimental diff editing, OpenRouter compression, sound effects, and making AI Code Orchestrator Cline (now AI Code Orchestrator) work in all VSCode-compatible editors and side-by-side with the original Cline.
...
- **Runs in All VSCode-Compatible Editors (v2.1.6):** AI Code Orchestrator Cline (now AI Code Orchestrator) was updated to run in all VSCode-compatible editors.
- **Side-by-Side with Cline (v2.1.4):** Enabled AI Code Orchestrator Cline (now AI Code Orchestrator) to run side-by-side with the original Cline extension.

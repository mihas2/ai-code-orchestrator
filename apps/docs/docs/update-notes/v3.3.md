---
description: AI Code Orchestrator 3.3 brings VS Code code actions, mode switching, Debug mode, experimental checkpoints, @terminal mentions, enhanced Markdown editing, and extensive provider updates.
keywords:
    - AI Code Orchestrator 3.3
    - code actions
    - debug mode
    - checkpoints
    - terminal mention
...
# AI Code Orchestrator 3.3 Release Notes (2025-02-27)
...
- **Project-Specific Custom Modes:** Support for project-specific custom modes in a `.agent-modes` file.
...
- **New Task Tool:** Added a `new_task` tool that allows AI Code Orchestrator to start new tasks with an initial message and mode.
...
- Fixed `.agent-modes` auto-creation.

---
description: AI Code Orchestrator 3.3.1 patch release fixes terminal management issues and mode switching bugs for improved stability and performance.
keywords:
    - AI Code Orchestrator 3.3.1
    - terminal management
    - mode switching
    - bug fixes
    - patch release
...
# AI Code Orchestrator 3.3.1 Release Notes

---
description: Learn how Codebase Indexing helps AI Code Orchestrator understand large projects using AI embeddings and semantic search. Setup guide for OpenAI and Qdrant integration.
keywords:
  - codebase indexing
  - semantic search
  - AI embeddings
...
Codebase Indexing transforms how AI Code Orchestrator understands your project by creating a semantic search index using AI embeddings. Instead of searching for exact text matches, it understands the *meaning* of your queries, helping AI Code Orchestrator find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`codebase_search`](/advanced-usage/available-tools/codebase-search) tool** to AI Code Orchestrator for intelligent code discovery
...
2. In AI Code Orchestrator settings:
   - Provider: **Google Gemini**
   - API Key: Your Google AI Studio key

:::info Other Providers Available
While this guide focuses on Google Gemini since it's currently free, AI Code Orchestrator also supports OpenAI, Ollama, OpenAI-compatible, Mistral, Vercel AI Gateway, Bedrock, and OpenRouter providers. You can explore these options in the configuration dropdown.
:::
...
You can monitor the status and manage all configuration for the codebase indexer directly from the AI Code Orchestrator chat interface.
...
- **Enhanced AI Understanding**: AI Code Orchestrator can better comprehend and work with your codebase
...
- Files matching `.aicoignore` patterns
...
- Fix:
  ...
  - AI Code Orchestrator will display a clear validation message if the key is invalid
...
- Consider adding patterns to `.aicoignore`

---

## Using the Search Feature

Once indexed, AI Code Orchestrator can use the [`codebase_search`](/advanced-usage/available-tools/codebase-search) tool:

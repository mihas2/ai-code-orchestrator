---
description: Learn about the experimental Background Editing setting that allows uninterrupted coding while AI Code Orchestrator makes file edits in the background.
keywords:
...
Work without interruption while AI Code Orchestrator edits files in the background—no more losing focus from automatic diff views.
...
The "Background Editing" setting is an experimental feature that disables automatic diff view displays when AI Code Orchestrator edits files. Instead of switching your editor focus to show diffs, AI Code Orchestrator works silently in the background, allowing you to continue coding without interruption. This feature affects all file editing operations including write, apply diff, search/replace, insert content, and multi-file apply diff tools.

### Key Benefits

- **Uninterrupted Focus**: Stay in your current file while AI Code Orchestrator makes changes
...
- **Limited Environment Context**: AI Code Orchestrator won't see recently edited files as open tabs in its environment details since they're not visually opened
...
1. Open AI Code Orchestrator settings (gear icon in the top right)
2. Navigate to the "Experimental" tab
3. Find "Background editing" in the list
4. Toggle the setting to enable it

<img src="/img/background-editing/background-editing.png" alt="Background editing setting in AI Code Orchestrator experimental features" width="400" />
...
Without this feature, when AI Code Orchestrator edits a file:
...
When enabled, AI Code Orchestrator's file edits:
...
- AI Code Orchestrator's chat shows what files were edited
...
- **Large Refactoring Operations**: When AI Code Orchestrator needs to update many files
...
4. **Monitor Chat**: Pay attention to AI Code Orchestrator's messages about file modifications
...
**Q: Can I still see what files AI Code Orchestrator edited?**
A: Yes, AI Code Orchestrator's chat messages list all modified files, and changes appear in source control.
...
**Q: Does this affect AI Code Orchestrator's ability to edit files?**
A: No, AI Code Orchestrator can still make all the same edits; only the display behavior changes. All file editing tools (write, apply diff, search/replace, insert content, and multi-file apply diff) respect this setting.

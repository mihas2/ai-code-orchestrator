...
description: Configure AI Code Orchestrator to use Mistral AI models including Codestral for code generation, with support for function calling and vision.
keywords:
    - Mistral AI
    - Codestral
...
# Using Mistral AI With AI Code Orchestrator

AI Code Orchestrator supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
AI Code Orchestrator supports all models available through Mistral AI's API.

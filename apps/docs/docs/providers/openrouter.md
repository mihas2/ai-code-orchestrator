---
description: Configure OpenRouter in AI Code Orchestrator to access 100+ language models from various providers through a single API with automatic model discovery.
keywords:
...
# Using OpenRouter With AI Code Orchestrator
...
AI Code Orchestrator automatically fetches all available models from OpenRouter's API (100+ models from various providers).
...
- **Bring Your Own Key (BYOK):** If you use your own key for the underlying service, OpenRouter charges 5% of what it normally would. AI Code Orchestrator automatically adjusts the cost calculation to reflect this.

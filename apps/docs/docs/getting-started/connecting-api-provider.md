...
description: Learn how to connect AI Code Orchestrator to AI providers like Anthropic Claude, OpenAI, and OpenRouter. Step-by-step guide for API key setup and configuration.
keywords:
    - AI Code Orchestrator API key
    - Claude API
    - OpenAI API
    - OpenRouter
    - Anthropic API
...
AI Code Orchestrator needs an inference provider to access the LLM models that make it work.
...
1. Open the AI Code Orchestrator panel by clicking the AI Code Orchestrator icon (<KangaaicoIcon />) in the VS Code Activity Bar

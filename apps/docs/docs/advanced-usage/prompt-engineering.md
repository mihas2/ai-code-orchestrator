---
description: Master the art of writing effective prompts for AI Code Orchestrator. Learn principles, techniques, and examples to get better AI coding assistance results.
keywords:
    - prompt engineering
    - AI prompts
...
Prompt engineering is the art of crafting effective instructions for AI models like AI Code Orchestrator. Well-written prompts lead to better results, fewer errors, and a more efficient workflow.

---

## General Principles

- **Be Clear and Specific:** Clearly state what you want AI Code Orchestrator to do. Avoid ambiguity.
...
It's often helpful to guide AI Code Orchestrator through a "think-then-do" process:

1.  **Analyze:** Ask AI Code Orchestrator to analyze the current code, identify problems, or plan the approach.
2.  **Plan:** Have AI Code Orchestrator outline the steps it will take to complete the task.
3.  **Execute:** Instruct AI Code Orchestrator to implement the plan, one step at a time.
...
You can provide custom instructions to further tailor AI Code Orchestrator's behavior. There are two types of custom instructions:
...
- Adjust AI Code Orchestrator's tone or personality.
...
If your request is ambiguous or lacks sufficient detail, AI Code Orchestrator might:
...
If AI Code Orchestrator doesn't produce the desired results, you can provide feedback by:

- **Rejecting Actions:** Click the "Reject" button when AI Code Orchestrator proposes an action you don't want.
- **Providing Explanations:** When rejecting, explain _why_ you're rejecting the action. This helps AI Code Orchestrator learn from its mistakes.
...
By following these tips, you can write effective prompts that get the most out of AI Code Orchestrator's capabilities.

...
- When AI Code Orchestrator needs to find code related to specific functionality across your project
...
- When implementing a new feature, AI Code Orchestrator searches for "authentication middleware" to understand existing patterns before writing new code.
- When debugging an issue, AI Code Orchestrator searches for "error handling in API calls" to find related error patterns across the codebase.
- When refactoring code, AI Code Orchestrator searches for "database transaction patterns" to ensure consistency across all database operations.
- When onboarding to a new codebase, AI Code Orchestrator searches for "configuration loading" to understand how the application bootstraps.

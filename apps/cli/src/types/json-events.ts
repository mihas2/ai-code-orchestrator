import {
	aicoCliOutputFormats,
	type AicoCliCost,
	type AicoCliEventType,
	type AicoCliFinalOutput,
	type AicoCliOutputFormat,
	type AicoCliQueueItem,
	type AicoCliStreamEvent,
	type AicoCliToolResult,
	type AicoCliToolUse,
 ...
 */
export const OUTPUT_FORMATS = aicoCliOutputFormats

export type OutputFormat = AicoCliOutputFormat
 ...
 */
export type JsonEventType = AicoCliEventType

export type JsonEventQueueItem = AicoCliQueueItem

/**
 * Tool use information for tool_use events.
 */
export type JsonEventToolUse = AicoCliToolUse

/**
 * Tool result information for tool_result events.
 */
export type JsonEventToolResult = AicoCliToolResult

/**
 * Cost and token usage information.
 */
export type JsonEventCost = AicoCliCost
 ...
 */
export type JsonEvent = AicoCliStreamEvent & {
 ...
 */
export type JsonFinalOutput = AicoCliFinalOutput & {
	/** Final result type */
	type: "result"

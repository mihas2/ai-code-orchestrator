 ...
 *
 * Users can override this with the AICO_NERD_FONT environment variable:
 * - AICO_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - AICO_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.AICO_NERD_FONT
	...
	// and users can set AICO_NERD_FONT=0 if needed
	return true
}

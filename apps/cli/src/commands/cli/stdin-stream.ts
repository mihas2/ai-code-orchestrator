...
import {
	aicoCliCommandNames,
	type AicoCliCommandName,
	type AicoCliInputCommand,
	type AicoCliStartCommand,
...
export type StdinStreamCommandName = AicoCliCommandName

export type StdinStreamCommand = AicoCliInputCommand

// ---------------------------------------------------------------------------
// Parsing
// ---------------------------------------------------------------------------

export const VALID_STDIN_COMMANDS = new Set<StdinStreamCommandName>(aicoCliCommandNames)
		...
		if (command === "start") {
			...
			if (isRecord(parsed.configuration)) {
				return {
					...
					configuration: parsed.configuration as AicoCliStartCommand["configuration"],
				}
			}
